        ...
        public void actionPerformed(ActionEvent e) {
            ...
            try{
                ...
                if(user != null){
                    ...
                    LOGGER.info("Felhasználónév: " + username + "jelszó: " + password + "sikeres bejelentkezés!");
                    view.setVisible(false);
                }
                else{
                    LOGGER.info("Felhasználónév: " + username + "jelszó: " + password + "failed to login.");
                    view.setLabelMessage("A megadott felhasználónév vagy jelszó helytelen.");
                }
